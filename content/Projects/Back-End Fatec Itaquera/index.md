...
For example, imagine that a professor changes the description of a class he teaches by adding more information and then chooses to commit those changes. The changes will be held as “To Be Approved” by a system administrator, or whatever name you prefer. This person would be responsible for validating whether the change was made correctly and did not damage any of the website’s content. Once approved, the changes held in the corresponding microservice’s database will have their status changed to approved and be sent to the main database, which contains the website’s current information.

## My role at the project

I developed the microservice responsible for managing the Extensions 
